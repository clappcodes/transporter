...
__export(mod_exports4, {
  ...
  transform: () => mod_exports3,
  utils: () => utils_exports,
  writable: () => mod_exports2
});
...
// global.ts
console.log(
  bgBlack(white(bold(deno_default.name))) + " " + gray(deno_default.version)
);
var table = {
  readable: Object.keys(mod_exports),
  writable: Object.keys(mod_exports2),
  transform: Object.keys(mod_exports3)
};
console.log(table);
Object.assign(globalThis, mod_exports4, { transporter: mod_exports4 });
